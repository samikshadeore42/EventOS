      ...
      case 'success':
        return (
          <div className="text-center">
            ...
            <Link to="/auth/login" className="inline-flex items-center px-4 py-2 rounded-lg text-sm font-medium text-white bg-gradient-to-r from-teal-600 to-teal-600 hover:from-teal-500 hover:to-teal-500">
              Sign in
            </Link>
          </div>
        );
      case 'already_verified':
        return (
          <div className="text-center">
            ...
            <Link to="/auth/login" className="font-medium text-teal-600 hover:text-teal-500">Sign in</Link>
          </div>
        );
      case 'expired':
        return (
          <div className="text-center">
            ...
            <Link to="/auth/login" className="font-medium text-teal-600 hover:text-teal-500">Return to sign in</Link>
          </div>
        );
      case 'invalid':
        return (
