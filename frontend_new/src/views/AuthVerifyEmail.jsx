      ...
      case 'already_verified':
        return (
          <div className="text-center">
            ...
            <Link to="/auth/login" className="font-medium shrink-0 hover:text-warning">Sign in</Link>
          </div>
        );
      case 'expired':
        return (
          <div className="text-center">
            ...
            <Link to="/auth/login" className="font-medium shrink-0 hover:text-warning">Return to sign in</Link>
          </div>
        );
      case 'invalid':
        return (
