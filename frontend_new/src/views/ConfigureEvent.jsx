      ...
      <div className="max-w-2xl mx-auto px-4 py-4">
        ...
        >
          ...
          <div className="border-t border-border p-3 flex gap-2">
            <input
              ref={inputRef}
              className="flex-1 bg-background border border-border text-foreground placeholder-muted rounded-xl px-4 py-2.5 text-sm outline-none focus:ring-1 focus:ring-primary focus:border-primary transition-all"
