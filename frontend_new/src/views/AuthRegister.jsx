            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  className="block w-full pl-10 font-mono bg-slate-100 text-slate-900 border border-slate-300 rounded-lg focus:ring-red-500 focus:border-red-500 sm:text-sm p-2.5"
