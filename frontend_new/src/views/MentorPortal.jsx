...
function PortalSkeleton() {
 ...
 <div className={isDark ? "animate-pulse w-full h-16 border-b bg-slate-950/90 border-white/10 border-white/10" : "bg-white/80 border-b border-slate-200 h-16 w-full animate-pulse"} />
...
function StatCard({ label, value, sub, statusText, colorTheme, icon: Icon }) {
 ...
 <div className={isDark ? "border-t pt-4 mt-auto border-white/10 border-white/10" : "mt-auto pt-4 border-t border-slate-200"}>
...
function DailyProgressForm({ teamId, members, token, onSuccess }) {
 ...
 <div className={isDark ? "mb-4 group overflow-hidden relative p-6 rounded-2xl border bg-slate-900/80 border-white/10" : "bg-slate-50 border border-slate-200 rounded-2xl p-6 relative overflow-hidden group mb-4"}>
 <div className="relative z-10">
 <div className={isDark ? "border-b pb-4 mb-5 gap-3 items-center flex border-white/10" : "flex items-center gap-3 mb-5 pb-4 border-b border-slate-200"}>
...
function WorkspaceCard({ title, icon: Icon, mainText, subText, actionText, onAction, colorTheme }) {
 ...
 return (
 <div className={isDark ? "mb-4 p-6 shadow-[0_14px_35px_rgba(15,23,42,0.05)] rounded-[22px] border bg-slate-900/80 border-white/10 border-white/10" : "bg-white border border-slate-200 rounded-[22px] shadow-[0_14px_35px_rgba(15,23,42,0.05)] p-6 mb-4"}>
...
function TeamCard({ team, token, eventId, mentorId }) {
 ...
 {expanded && (
 <div className={isDark ? "mt-4 overflow-hidden shadow-[0_22px_60px_rgba(15,23,42,0.10)] rounded-[28px] border bg-slate-950/90 border-white/10 border-white/10" : "bg-white/95 border border-slate-200 rounded-[28px] shadow-[0_22px_60px_rgba(15,23,42,0.10)] overflow-hidden mt-4"}>
 {/* Header */}
 <div className={isDark ? "border-b py-6 px-8 border-white/10 border-white/10" : "px-8 py-6 border-b border-slate-200"}>
...
function MentorPortalContent() {
 ...
 <div className={isDark ? "shadow-sm border rounded-[24px] bg-white/90 py-16 text-center border-white/10 border-white/10" : "text-center py-16 bg-white/90 rounded-[24px] border border-slate-200 shadow-sm"}>
